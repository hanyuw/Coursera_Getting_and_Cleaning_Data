...
train = cbind(train_label, train_data)
train$subject = "trainingset"

test = cbind(test_label, test_data)
test$subject = "testingset"
...
names(Mdata) = c("ID", "Labels", as.character(features[,2]), "subject")
```
...
msT = Mdata[ ,c("ID", "Labels", measurements, "subject")]
#head(msT)
```
