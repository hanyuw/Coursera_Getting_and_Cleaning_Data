...
Finally first two columns of the dataset give the following info:

•activity - descriptive labels of the activities: 'LAYING','SITTING','STANDING','WALKING','WALKING_DOWNSTAIRS','WALKING_UPSTAIRS'
•subject - identifies subject
